    ...
    <div class="col-sm-12 col-md-12">
        <div class="tabbable tabbable-bordered">
            <ul class="nav nav-tabs">
                ...
                <li id="tabhistory"><a href="#tab4" data-toggle="tab">History</a></li>
            </ul>
                ...
                <div class="tab-pane" id="tab2">
                    <div class="row">
                        <div class="col-sm-9 col-md-9">
                            <div class="form-horizontal" role="form">
                                <div id="divfileSuratKetGub" class="form-group">
                                    <label for="fileSuratKetGub" class="col-lg-2 control-label">Surat Keterangan Gub</label>
                                    <div class="col-lg-4">
                                        <input type="file" class="input-sm form-control" id="fileSuratKetGub">
                                        <span class="help-block">* File yang hanya perbolehkan pdf, jpg, png, rar</span>
                                    </div>
                                    <div class="col-lg-3">
                                        <div id="btnFL04"></div>
                                ...
                                <div id="divfileMatrikEvaluasi" class="form-group">
                                    <label for="fileMatrikEvaluasi" class="col-lg-2 control-label">Matrik Evaluasi</label>
                                    <div class="col-lg-4">
                                        <input type="file" class="input-sm form-control" id="fileMatrikEvaluasi">
                                        <span class="help-block">* File yang hanya perbolehkan pdf, jpg, png, rar</span>
                                    </div>
                                    <div class="col-lg-3">
                                        <div id="btnFL05"></div>
                                ...
                                <div class="formSep"></div>
                                <div id="divfileKepGubEvaluasi" class="form-group">
                                    <label for="fileKepGubEvaluasi" class="col-lg-2 control-label">Kep Gubernur (Evaluasi)</label>
                                    <div class="col-lg-4">
                                        <input type="file" class="input-sm form-control" id="fileKepGubEvaluasi">
                                        <span class="help-block">* File yang hanya perbolehkan pdf, jpg, png, rar</span>
                                    </div>
                                    <div class="col-lg-3">
                                        <div id="btnFL07"></div>
                        ...
                        <div class="col-sm-9 col-md-9">
                            <div class="form-horizontal" role="form">
                                <div id="divfileSuratHasilKonsul" class="form-group">
                                    <label for="fileSuratHasilKonsul" class="col-lg-2 control-label">Surat Hasil Konsultasi</label>
                                    <div class="col-lg-4">
