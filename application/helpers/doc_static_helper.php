    ...
    class doc_static extends FPDF {
      ...
      public function rptDetailData () {
          ...
          if($header->ktg_id == 1){
              ...
              $cols2 = "Belanja Tambahan Penghasilan PNS";
          }

          if($header->ktg_id == 2){
            $cols1 = "Kegiatan Pinjaman Daerah Yang Diusulkan Dalam KAK Pemerintah Daerah";
            $cols2 = "Jumlah";
          }
		  ...
		  $this->SetX($left += 20); $this->Cell(350, $h, $cols1, 1, 0, 'C',true);
		  $this->SetX($left += 350); $this->Cell(170, $h, $cols2, 1, 1, 'C',true);
          //$this->Ln(20);
          
          $this->SetFont('Arial','',9);
		  $this->SetWidths(array(20,350,170));
