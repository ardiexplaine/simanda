<?php  
    ...
    class doc_belanja extends FPDF {
      ...
      public function rptDetailData () {
          ...
          if($header->ktg_id == 7){
              ...
              $cols2 = "Honorarium Panitia Pelaksana";
              $cols3 = "Honorarium TA/Instruktur/Narasumber";
          ...
          $this->SetX($left += 170); $this->Cell(140, $h, $cols2, 1, 0, 'C',true);
          $this->SetX($left += 140); $this->Cell(160, $h, $cols3, 1, 0, 'C',true);
          $this->SetX($left += 160); $this->Cell(140, $h, $cols4, 1, 0, 'C',true);
          $this->SetX($left += 140); $this->Cell(140, $h, $cols5, 1, 1, 'C',true);
          //$this->Ln(20);

          
          $this->SetFont('Arial','',9);
		  $this->SetWidths(array(20,170,140,160,140,140));
